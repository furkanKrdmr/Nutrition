...
<div class="tarif-main-box">
    <h2>Mes abonnements</h2>
    <div class="tarif-all-subscription">
        <div class="tarif-subscription">
            <p class="tarif-month">3 mois</p>
            <p>150 € / mois</p>
            <p>2 séances / mois</p>
        </div>
        <div class="tarif-subscription">
            <p class="tarif-month">6 mois</p>
            <p>120 € / mois</p>
            <p>2 séances / mois</p>
        </div>
        <div class="tarif-subscription">
            <p class="tarif-month">12 mois</p>
            <p>100 € / mois</p>
            <p>2 séances / mois</p>
        </div>
    </div>
    ...
    <div class="txtbutton">
        <p class="text-bas-page">Vous voulez me contacter ? Cliquer sur le bouton ! </p>
        <p class="button-bas-page"><a href="contact.php">Contactez moi !</a></p>
    </div>
